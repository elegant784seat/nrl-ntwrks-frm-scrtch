...
MnistLoader::MnistLoader(std::filesystem::path directory)
...
Dataset MnistLoader::loadTrain() const {
  ...
  std::cout << "Opening train labels: "
            << std::filesystem::absolute(labels_path) << std::endl;
